...
### 🔄 2. 곡 목록 탐색 중 실시간 기록 자동 동기화
* **[체감 변화]**: 게임 내 곡 목록을 둘러보는 것만으로도 확인된 최신 플레이 기록이 오버레이에 즉시 반영됩니다.
* **[개선 세부 요약]**: 곡 목록 화면에서 커서가 위치한 곡의 모드/난이도/점수가 안정적으로 인식되면, 백그라운드 로컬 기록에 자동으로 동기화되어 추천 곡 목록과 난이도 탭 정보를 최신 상태로 갱신합니다.
