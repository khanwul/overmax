...
* **[개선 세부 요약]**:
  ...
  * **미보유 DLC 자동 제외 및 미플레이 곡 스마트 추천**: 플레이어가 소유하지 않은 DLC 곡이 무차별 추천되어 선곡에 불편을 겪는 일이 없도록 보유 DLC를 자동 추론하여 제외하며, 보유한 팩 내에서 아직 도전해보지 않은 미플레이 곡(`CLR`)을 적정 난이도에 맞춰 우선 발굴해 드립니다.
...
### 🧹 2. 미플레이 곡 점수 잔류 방지 및 과거 오기록 자동 정화
